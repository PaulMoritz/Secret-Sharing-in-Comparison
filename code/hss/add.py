...
def add(setup, old_shares, new_shareholder_id=(0, 0), choose_id_randomly=False,
    ...
    determinant_of_original_matrix, matrix, rec_result = check_validity_of_subset(existing_shares, r, setup)
    # troubleshooting
...
def check_validity_of_subset(existing_shares, r, setup):
    try:
        ...
        raise
    return determinant_of_original_matrix, matrix, rec_result
